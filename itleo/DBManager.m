...
-(BOOL)fn_create_table{
    ...
    if (![database open]) {
        ...
        NSString *ls_sql_order_list= @"CREATE TABLE IF NOT EXISTS order_list( unique_id INTEGER PRIMARY KEY,order_uid TEXT NOT NULL DEFAULT '',order_no TEXT NOT NULL DEFAULT '',status TEXT NOT NULL DEFAULT '',remark TEXT NOT NULL DEFAULT '',pick_addr TEXT NOT NULL DEFAULT '',dely_addr TEXT NOT NULL DEFAULT '',sign_path TEXT NOT NULL DEFAULT '',sign_path_base64 TEXT NOT NULL DEFAULT '',voided TEXT NOT NULL DEFAULT '',update_time TEXT NOT NULL DEFAULT '',is_confirm TEXT NOT NULL DEFAULT '',read_date TEXT NOT NULL DEFAULT '',is_read TEXT NOT NULL DEFAULT '',is_sync_read TEXT NOT NULL DEFAULT '')";
        NSString *ls_sql_order_dtl_list= @"CREATE TABLE IF NOT EXISTS order_dtl_list( unique_id INTEGER PRIMARY KEY,pgdw_lot_uid TEXT NOT NULL DEFAULT '',descp TEXT NOT NULL DEFAULT '',pkg TEXT NOT NULL DEFAULT '',item_pic_path TEXT NOT NULL DEFAULT '',item_pic_path_base64 TEXT NOT NULL DEFAULT '',order_uid TEXT NOT NULL DEFAULT '')";
        ...
        [database executeUpdate:ls_sql_order_list];
        [database executeUpdate:ls_sql_order_dtl_list];
        //control permit data
