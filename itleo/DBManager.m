...
-(BOOL)fn_create_table{
    ...
    if (![database open]) {
        ...
        NSString *ls_sql_whs_header= @"CREATE TABLE IF NOT EXISTS whs_config_header( unique_id INTEGER PRIMARY KEY,EN TEXT NOT NULL DEFAULT '',CN TEXT NOT NULL DEFAULT '',TCN TEXT NOT NULL DEFAULT '',ENABLE TEXT NOT NULL DEFAULT '',UPLOAD_TYPE TEXT NOT NULL DEFAULT '')";
        NSString *ls_sql_whs_detail= @"CREATE TABLE IF NOT EXISTS whs_upload_col( uid INTEGER PRIMARY KEY,seq TEXT NOT NULL DEFAULT '',col_field TEXT NOT NULL DEFAULT '',col_lable_en TEXT NOT NULL DEFAULT '',col_lable_cn TEXT NOT NULL DEFAULT '',col_lable_tcn TEXT NOT NULL DEFAULT '',col_type TEXT NOT NULL DEFAULT '',col_option TEXT NOT NULL DEFAULT '',col_def TEXT NOT NULL DEFAULT '',group_name_en TEXT NOT NULL DEFAULT '',group_name_cn TEXT NOT NULL DEFAULT '',group_name_tcn TEXT NOT NULL DEFAULT '',is_mandatory TEXT NOT NULL DEFAULT '',unique_id INTEGER,FOREIGN KEY (unique_id) REFERENCES whs_config_header(unique_id))";
         NSString *ls_sql_whs_data= @"CREATE TABLE IF NOT EXISTS whs_log(unique_id INTEGER PRIMARY KEY,upload_type TEXT NOT NULL DEFAULT '',user_code TEXT NOT NULL DEFAULT '',company_code TEXT NOT NULL DEFAULT '',type_code TEXT NOT NULL DEFAULT '',order_no TEXT NOT NULL DEFAULT '',ref_no TEXT NOT NULL DEFAULT '',value TEXT NOT NULL DEFAULT '',excu_datetime TEXT NOT NULL DEFAULT '',result_status TEXT NOT NULL DEFAULT '',result_message TEXT NOT NULL DEFAULT '',refkey TEXT NOT NULL DEFAULT '',free1 TEXT NOT NULL DEFAULT '',free2 TEXT NOT NULL DEFAULT '',free3 TEXT NOT NULL DEFAULT '',free4 TEXT NOT NULL DEFAULT '',free5 TEXT NOT NULL DEFAULT '',free6 TEXT NOT NULL DEFAULT '',free7 TEXT NOT NULL DEFAULT '',free8 TEXT NOT NULL DEFAULT '',free9 TEXT NOT NULL DEFAULT '',free10 TEXT NOT NULL DEFAULT '',free11 TEXT NOT NULL DEFAULT '',free12 TEXT NOT NULL DEFAULT '',free13 TEXT NOT NULL DEFAULT '',free14 TEXT NOT NULL DEFAULT '',free15 TEXT NOT NULL DEFAULT '',free16 TEXT NOT NULL DEFAULT '',free17 TEXT NOT NULL DEFAULT '',free18 TEXT NOT NULL DEFAULT '',free19 TEXT NOT NULL DEFAULT '',free20 TEXT NOT NULL DEFAULT '')";
        //login data
