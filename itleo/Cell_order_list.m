...
@property (weak, nonatomic) IBOutlet UILabel *ibl_phone_num;
...
- (void)setOrder_obj:(Resp_order_list *)order_obj{
    ...
    _ibl_phone_num.text=order_obj.ilb_phone_num;
    
    _ilb_update_time.text=order_obj.ilb_update_time;
    ...
    _ilb_order_status.text=[NSString stringWithFormat:@"(%@)",order_obj.ilb_order_status];
    ...
    CGSize ilb_desSize=[order_obj.ilb_destination_addr boundingRectWithSize:CGSizeMake(ilb_desWidth, MAXFLOAT) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:_ilb_destination_addr.font} context:nil].size;
    ...
    CGSize ilb_remarkSize=[order_obj.ilb_remark boundingRectWithSize:CGSizeMake(ilb_remarkWidth, MAXFLOAT) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:_ilb_remark.font} context:nil].size;
    CGRect ilb_remarkRect= CGRectMake(ilb_remarkX,ilb_remarkY, ilb_remarkSize.width, ilb_remarkSize.height);
    _ilb_remark.text=order_obj.ilb_remark;
